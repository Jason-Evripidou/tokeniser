...
namespace bpe
{
    namespace
    {
        //-----------------------------------------------------------------------------------//
        /*
        -   Lookup tables used by the MD5 hashing algorithm. Values are standard constants from
        |   MD5.
        */
        //-----------------------------------------------------------------------------------//
    ...
    //---------------------------------------------------------------------------------------//
    /*
    -   md5_hex: Compute the MD5 hash of a vector of Bytes and return that hash as a
    |   32-character (128 bit) hexadecimal string.
    ...
    */
    ...
    {
        // fixed constants defined by the MD5 algorithm.
